...
if __name__ == '__main__':
    ...
    cv.setMouseCallback('input', onmouse)# callback 前面的鼠标命令
    print(img.shape[1])
    #cv.moveWindow('input', img.shape[1] + 10, 90)
    #cv.moveWindow('output', img.shape[1] + 10 + img.shape[1]+10 , 90)
    ...
    while(1):
        ...
        if k == 27:         # esc to exit
            ...
            res = cv.resize(res, (res.shape[1] *8, img.shape[0] * 8), interpolation = cv.INTER_CUBIC)
